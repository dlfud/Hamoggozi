...
public class PostController {
    ...
    public ResponseEntity<Map<String, String>> insertPost(@RequestBody PostBean postBean) throws Exception {
    ...
    public ResponseEntity<Map<String, String>> updatePost(@RequestBody PostBean postBean) throws Exception {
        Map<String, String> resultMap = new HashMap<>();
